...
export default function TrustBar() {
    ...
    const stats = [
        { icon: <Users className="w-5 h-5" />,      value: t("clients"),      color: "#00D4FF" },
        { icon: <Clock className="w-5 h-5" />,       value: t("uptime"),       color: "#4ADE80" },
        { icon: <Headphones className="w-5 h-5" />,  value: t("support"),      color: "#FF6B9D" },
        { icon: <Zap className="w-5 h-5" />,         value: t("response"),     color: "#FFD700" },
    ];
